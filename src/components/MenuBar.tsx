...
export default function MenuBar({ setData, setColumns }: ToolBarProps) {
    ...
    <>
      <div className="w-full flex justify-between items-center py-1 border-b border-border">
        ...
        <div className="flex gap-1 items-center">
          <button
            className="flex items-center justify-center gap-1 w-8 lg:w-22 px-2 lg:px-0 py-2 rounded-md hover:bg-secondary/30"
